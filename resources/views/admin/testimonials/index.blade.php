...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">                
                <h1 class="page-header">Testimonials <a class="btn btn-sm btn-primary pull-right" href="{!! route('testimonials.create') !!}"> <i class="fa fa-plus fa-fw"></i> Add New Testimonial</a></h1>
