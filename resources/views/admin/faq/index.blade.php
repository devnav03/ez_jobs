...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">                
                <h1 class="page-header">FAQ's Listing  <a class="btn btn-sm btn-primary pull-right" href="{!! route('faqs.create') !!}"> <i class="fa fa-plus fa-fw"></i> Add New FAQ's</a></h1>
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        ...
                        <form action="{{ route('faqs.action') }}" method="post">
                            ...
                            <table id="paginate-load" data-route="{{ route('faqs.paginate') }}" class="table table-hover">
                            </table>
                        </form>
                    </div>
