                          ...
                          <!--   <div class="form-title">
                            ...
                            <div class="form-body">
                                ...
                                <!--     <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group"> 
                                            <label for="privacy_policy" style="font-size: 16px; margin-bottom: 5px;">Privacy Policy<span>*</span></label>
                                            {!! Form::textarea('privacy_policy', null, array('class' => 'form-control')) !!}
                                    ...
                                    <div class="col-md-12 mgn20">
                                        <div class="form-group"> 
                                            <label for="terms_condition" style="font-size: 16px; margin-bottom: 5px;">Terms & Conditions<span>*</span></label>
                                            {!! Form::textarea('terms_condition', null, array('class' => 'form-control')) !!}
