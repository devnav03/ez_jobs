...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">                
                <h1 class="page-header">{!! lang('category.category') !!} Listing  <a class="btn btn-sm btn-primary pull-right" href="{!! route('category.create') !!}"> <i class="fa fa-plus fa-fw"></i> {!! lang('common.create_heading', lang('category.category')) !!} </a></h1>
