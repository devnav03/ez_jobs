...
<tr id="order_{{ $detail->id }}">
    ...
    <td class="text-center col-md-1">
        ...
        <!-- <a title="{!! lang('common.delete') !!}" class="btn btn-xs btn-danger __drop" data-route="{!! route('blogs.drop', [$detail->id]) !!}" data-message="{!! lang('messages.sure_delete', string_manip(lang('blogs.blogs'))) !!}" href="javascript:void(0)">
