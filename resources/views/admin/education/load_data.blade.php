...
<tr id="order_{{ $detail->id }}">
    ...
    <td class="text-center col-md-1">
        ...
        <a title="{!! lang('common.delete') !!}" class="btn btn-xs btn-danger __drop" data-route="{!! route('education.drop', [$detail->id]) !!}" data-message="{!! lang('messages.sure_delete', string_manip(lang('Education'))) !!}" href="javascript:void(0)"><i class="fa fa-times"></i> </a>
    </td>    
</tr>
@endforeach
@if (count($data) < 1)
