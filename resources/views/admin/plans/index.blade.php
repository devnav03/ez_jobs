...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">                
                <h1 class="page-header">Plans List  <a class="btn btn-sm btn-primary pull-right" href="{!! route('plans.create') !!}"> <i class="fa fa-plus fa-fw"></i> Add New Plan</a></h1>
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        ...
                        <form action="{{ route('plans.action') }}" method="post">
                            ...
                            <table id="paginate-load" data-route="{{ route('plans.paginate') }}" class="table table-hover">
                            </table>
                        </form>
                    </div>
