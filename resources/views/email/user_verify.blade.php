      ...
      <tbody>
        <tr>
          <td style=" font-family: -apple-system, BlinkMacSystemFont, Roboto, sans-serif;
            ...
            ">
            <img src="{{route('home')}}/assets/frontend/images/logo.svg" class="carpool_logo" width="200" style="  display: block;
              margin: 0 auto;
              margin: 30px auto;">
          </td>
        </tr>
                ...
                <tr>
                  <td class="section_content_padded" style="  font-family: -apple-system, BlinkMacSystemFont, Roboto, sans-serif;
                    ...
                    <h1 style=" font-size: 20px;
                      ...
                      margin-bottom: 0;
                      ">Hi {{ $name }},</h1>
                    <p class="near_title last" style="margin-top: 10px;margin-bottom: 0;">You have been successfully registered with ez-job.co. Kindly click below to verify your Account</p>
