...
<img src="{!! asset($company->profile_image) !!}" style="border-radius: 8px;" alt="">
</div>
<div class="col-md-11">
<h3>{{ $company->employer_name }} <span style="background: hsl(111deg, 55%, 95%);color: #0BA02C;">Verified</span> <span style="color: #0a65cc;background: #eef5fc;">Featured</span></h3>
