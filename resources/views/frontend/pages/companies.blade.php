...
<select class="rt-selectactive w-100-p select2-hidden-accessible" name="country_name" onChange="getState(this.value);">
...
<button onclick="CompanyFilter()" class="btn btn-primary d-block d-md-inline-block ">Find Company</button>
</div>
</div>
